...
| 0 | `CANO` | 종합계좌번호 | string | Y | 8 | 계좌번호 체계(8-2)의 앞 8자리 |
| 1 | `ACNT_PRDT_CD` | 계좌상품코드 | string | Y | 2 | 계좌번호 체계(8-2)의 뒤 2자리 |
| 2 | `AFHR_FLPR_YN` | 시간외단일가, 거래소여부 | string | Y | 1 | N : 기본값,<br>Y : 시간외단일가,<br>X : NXT 정규장 (프리마켓, 메인, 애프터마켓)<br>※ NXT 선택 시 : NXT 거래종목만 시세 등 정보가 NXT 기준으로 변동됩니다. KRX 종목들은 그대로 유지 |
...
| 0 | `CANO` | 종합계좌번호 | string | Y | 8 | 계좌번호 체계(8-2)의 앞 8자리 |
| 1 | `ACNT_PRDT_CD` | 계좌상품코드 | string | Y | 2 | 계좌번호 체계(8-2)의 뒤 2자리 |
| 2 | `AFHR_FLPR_YN` | 시간외단일가여부 | string | Y | 1 | 'N : 기본값 <br>Y : 시간외단일가' |
