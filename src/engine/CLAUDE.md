...
**session.py** (사이클 162 (2026-06-18) — `SessionTracker.is_call_auction_now(now=None) -> bool` 신규. KIS MCP 정본 H0UNMKO0 `MKOP_CLS_CODE` = 110 (장전 동시호가 08:30~09:00) / 121 (장후 동시호가 15:20~15:30) 코드 기반 인지 + 시간 기반 폴백. domain-expert 자문 산출물 `_workspace/domain_consult/cycle162_pending_persist_and_call_auction.md`.)
