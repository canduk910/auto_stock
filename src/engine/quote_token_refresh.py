...
루프 수명 구조를 바꾸지 않는 한 불가능하다(20:00~정산 은 자문·유니버스·정산의 REST
...
- 19:50 `TIME_NXT_POST_BUY_STOP` / 20:00 자문·유니버스·NXT 종료 / 20:30 일봉 / 21:30 정산 — T+8분(19:08) 이전
...
# T+8분이 19:50/20:00 앞이며, **T 가 스케줄러 루프 생존 창(~`TIME_SETTLEMENT`, 현행 21:30) 안**이어야 한다.
