...
### 09:00 직후 진입 보류 `open_entry_hold_secs` (cycle262) — **VB 에도 적용된다**
VB·LTV 공통 계약이라 정본은 아래 §5 끝의 전용 절에 한 번만 둔다. 요약 = KRX 개장 후 기본 **90초**
동안 **신규 매수 신호만** 보류(청산 계열 전부 무접촉), **지혈이며 근본 시정이 아니다**.
→ [§5 「09:00 직후 진입 보류 `open_entry_hold_secs`」](#0900-직후-진입-보류-open_entry_hold_secs-cycle262-2026-09-06--지혈이며-근본-시정이-아니다)
