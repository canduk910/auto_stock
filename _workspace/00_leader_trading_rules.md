...
### 전략 G: 고지로 대순환 스윙 (strategy_id: kojiro) — 2026-07 Phase 1 다크런치
이동평균선 대순환(EMA 5/20/40 배열 스테이지) 추세추종. donchian 정공법 보강 — "질서정연한 추세"를 EMA 정배열 상태로 포착.
- **유니버스**: 코스피200∪코스닥150 지수고정 + 시총/거래대금 컷 + **ATR/종가 변동성 밴드 1.0~4.5%(비협상 판별 필터 — <1% 노이즈·>4.5% 급등작전주 배제)**.
- **매수(strict entry, 4조건 AND)**: ① 현재 스테이지 1(단기>중기>장기) ② 최근 3영업일 내 6→1 전환 인접(신선도) ③ EMA 3선 우상향 ④ 전일 종가 > EMA5. **KRX 메인 09:05~09:30 시장가**, 갭업 ≥5% / 갭다운 ≤-4% / 장중 붕괴(현재가<시가) 스킵, 1회만.
