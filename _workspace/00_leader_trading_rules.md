...
### 익일 청산 (다음 영업일 NXT 프리 08:00)
- 전일 매수하여 보유 중인 종목에 대해 다음 영업일 **NXT 프리 첫 거래(08:00 부근) 시가 + 30초 안정화** 후 청산 (`NEXT_DAY_STABILIZE_SECS=30`)
- **갭상승 판단**: NXT 프리 시가가 매수 체결가 대비 +10% 이상
  - Yes → 고점 대비 -2% 트레일링 스탑 가동, 조건 충족 시 시장가 매도
  - No → 즉시 시장가 전량 매도 (익절 또는 손절)
- **이전 모델(KRX 09:00 청산) 대비 1시간 단축** + KRX 09:00 동시호가 흔들림 회피
