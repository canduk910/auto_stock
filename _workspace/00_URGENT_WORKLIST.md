...
| ⑬ | README.md · docs/architecture.md 의 ASCII 구성도를 Mermaid 로(그림 블록만, bash/env·트리·로그는 유지, `mmdc` 문법 검증) | **진행(09-25 사용자: 이것부터)** |
...
| D7 피라미딩 문턱 | 일봉 보관을 **730일** 정도로 늘리는 방안 검토(백테스트에도 730일 필요) |
| D8 카드 E | 지금 준비 |
