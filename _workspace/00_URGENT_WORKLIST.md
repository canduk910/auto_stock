...
- 🔴 **VCP `max_lot_ratio_mult = 20.0`** — 7전략 중 유일(나머지 2.5). cycle245 §7.1 선반영값(ρ축 캡 해제
  다이얼)이 BFB 만 2.5 로 돌아오고 VCP 에 남았다. **09-10 밤 보고서 결정 카드 "K_ρ 20 만료" 가 아직
  회신 대기다.** VCP 는 체결 0건이라 현재 실효는 없지만, 첫 체결이 나면 그 랏이 ρ축 심사를 사실상 안 받는다.
