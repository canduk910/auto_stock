...
- **진행 2(조건부)**: RS 강세 반사실 결과가 부정적이면 스윙군(donchian·kojiro·VCP) 3종 필터 검토 착수 — 계획서 `_workspace/specs/swing_3filter_review_plan.md`. 훅이 없어 점수는 오프라인 계산, 재무 데이터는 08-12 이후 정지(347종목) 제약.
