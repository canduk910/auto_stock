...
_BASE_SHA = {
    ...
    "src/engine/order_engine.py": "2e10df625e9857b2a6b939f64f5e22849cba1890445a80481d1e889ac002d23a",
    ...
    "src/engine/scheduler.py": "088d54efc4927899c1048d01ea7c15265ce87858da25447ac28a1ffaa56f3c23",
...
def test_c16_1_scheduler_line_count_unchanged() -> None:
    ...
    assert lines == 3785, f"scheduler.py {lines}L (기대 3,785 — cycle283 저녁 창 재설계 뒤 3,897 → cycle292 leaf 추출 → cycle298 재핀)"
