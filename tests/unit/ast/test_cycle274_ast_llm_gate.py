...
_BASE_SHA = {
    ...
    "src/engine/scheduler.py": "8bc235d460d26f8da4aba9c4af5132c49347138f6d428d9ba78321c77b7cfafe",
...
def test_c16_1_scheduler_line_count_unchanged() -> None:
    ...
    assert lines == 3757, f"scheduler.py {lines}L (기대 3,757 — cycle283 저녁 창 재설계 뒤 3,897 → cycle292 leaf 추출 → cycle298 재핀)"
